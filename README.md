...
The preferred action link is now `/recharge?api_key=...`, which opens a browser checkout page with the API key locked and amount options for 5, 10, 20, 50, and 100 yuan. The checkout page creates an Alipay order QR code for the selected amount.
